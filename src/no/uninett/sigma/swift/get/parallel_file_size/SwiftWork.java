package no.uninett.sigma.swift.get.parallel_file_size;
/********************************************************************
...
//		System.out.println((long) (value * Math.pow(1024, exp)));
	 ...
	 */
	public static double convertRateToXbps(double byteps, SwiftGetPFSKernelMain.SizeUnit unit){
		switch (unit) {
		case b:
			return (byteps * 8);
	 ...
	 */
	public static double convertFileSize(double sizeInByte, SwiftGetPFSKernelMain.SizeUnit unit){
		switch (unit) {
		case b:
			return (sizeInByte * 8);
